...
namespace mute_it
{
    class MuteItContext : ApplicationContext
    {
        ...
        private HotkeyManager registerHotkeys()
        {
            ...
            RegisterHotKey(manager.Handle, MUTE_CODE, Constants.WIN, (int)Keys.Delete);
            RegisterHotKey(manager.Handle, UNMUTE_CODE, Constants.WIN, (int)Keys.Insert);
        ...
        public void setMicMuteStatus(bool doMute)
        {
            ...
            if (doMute)
                fm1.pictureBox1.Image = new Bitmap("mic0.png");
            else
                fm1.pictureBox1.Image = new Bitmap("mic1.png");
            fm1.Show();
            if (device != null)
            {
